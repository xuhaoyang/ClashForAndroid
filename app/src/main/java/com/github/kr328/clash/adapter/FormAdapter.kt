...
class FormAdapter(private val context: Context, private val elements: List<FormFragment.FormElement>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when ( viewType ) {
            FormFragment.FormType.STRING.ordinal, FormFragment.FormType.FILE.ordinal, FormFragment.FormType.URL.ordinal ->
                TextHolder(LayoutInflater.from(context).inflate(R.layout.adapter_from_text, parent, false))
